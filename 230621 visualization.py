...
So_c0 = df.reset_index()['S c0 omega'].fillna(0).to_numpy()
So_c1 = df.reset_index()['S c1 omega'].fillna(0).to_numpy()
So_c2 = df.reset_index()['S c2 omega'].fillna(0).to_numpy()
So_c3 = df.reset_index()['S c3 omega'].fillna(0).to_numpy()
So_c4 = df.reset_index()['S c4 omega'].fillna(0).to_numpy()
So_c5 = df.reset_index()['S c5 omega'].fillna(0).to_numpy()
